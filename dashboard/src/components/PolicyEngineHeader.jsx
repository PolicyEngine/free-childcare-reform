...
// rewrites proxy this app under policyengine.org/uk/free-childcare-reform
// but do not inject the parent site shell, so — like the other published
// dashboards — we render the header/nav here. Links point at the UK site so the tool sits
