...
**The labour supply response is small and, on the central assumption, slightly positive.** Free hours give **−17,014** net entrants — making 15 hours unconditional removes a reason to work — while the subsidy gives **+11,919**, because cheaper childcare makes work pay. Together, **+2,794**, worth about £0.019bn.

The sign has moved twice under review and should not be leaned on. It has moved four times under review: +5,558 on a double-counted subsidy; −10,361 after correcting that; +3,662 after fixing an entity-mapping error, where support was read on the child's row and every adult saw zero; and +2,794 after restricting the out-of-work support adjustment to people already in work, since for a non-worker it was a third credit. All four were errors here, found by audit rather than by this repository's own tests. What is robust is the magnitude: the response is small against a £6.6bn reform on every version, and the two legs pull hard against each other.
