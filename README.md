...
**The childcare fee base is the largest uncertainty.** The subsidy pays a share of what families spend, and for England's under-5s the model has £6.36bn of fees against a published estimate of £5.10bn — **1.25×**. Scaling the model's under-5 fees to that estimate takes the subsidy leg to £4.18bn and both legs to £6.00bn. Free hours are unaffected, so they set a floor. Read the combined cost as **£6.00bn to £6.64bn**.

**The labour supply response is small and, on the central assumption, slightly negative.** Free hours give **−13,114** net entrants — making 15 hours unconditional removes a reason to work — while the subsidy gives **+7,781**, because cheaper childcare makes work pay. Together, **−5,631**. The fiscal effect is under £0.01bn either way.

An earlier version of this analysis reported **+5,558**, and the sign changed when a double-count was removed: `household_net_income` excludes Tax-Free Childcare, so netting the subsidy off the childcare a worker pays already credits it, and subtracting it from out-of-work income as well counted the same subsidy twice for every potential entrant. Correcting it roughly halves the subsidy leg's response, which is enough for the free-hours leg's negative to dominate. Treat the sign as genuinely uncertain rather than as a finding.

HMT's 60,000 entrants for the 2023 expansion is not the right yardstick: that expansion *added* work-conditional hours, where this reform *removes* conditionality. The comparable figure is the subsidy leg's +7,781 against the IFS's ~12,000 for the 15-to-30-hour expansion.
