...
Do not read £6.00bn as a lower bound. The CMA does not publish £5.1bn as gross parent-paid fees: it is a residual of an uncertain £14bn sector-income estimate less £8.9bn of entitlement funding, and that residual contains other provider income too. The comparison also sets a 2025-26 residual against 2027-28 nominal fees. Scenarios in the other direction exceed the headline. Each is a combined run with free hours displacing paid care, not standalone legs added together — an earlier version of this README published the additive sums, which overstate every scenario by about £0.2bn: full take-up within the coded scope gives £7.04bn, including Universal Credit families gives £7.96bn, and doing both gives £8.86bn. Treat £6.00bn as one fixed-quantity accounting scenario among several, not the end of an interval.

**The labour supply response is small and, on the central assumption, slightly positive.** Free hours give **−17,014** net entrants — making 15 hours unconditional removes a reason to work — while the subsidy gives **+11,930**, because cheaper childcare makes work pay. Together, **+2,804**, worth about £0.019bn.

The sign has moved twice under review and should not be leaned on. It has moved four times under review: +5,558 on a double-counted subsidy; −10,361 after correcting that; +3,662 after fixing an entity-mapping error, where support was read on the child's row and every adult saw zero; and +2,804 after restricting the out-of-work support adjustment to people already in work, since for a non-worker it was a third credit. All four were errors here, found by audit rather than by this repository's own tests. What is robust is the magnitude: the response is small against a £6.6bn reform on every version, and the two legs pull hard against each other.
...
**The intensive margin is much larger, and overlaps with it.** Parents already in work and paying for childcare see their out-of-pocket cost fall by about 79% under both legs together, and at a childcare price elasticity of hours of −0.042 that is 3.3% more hours: about 41,448 full-time equivalents, £2.22bn of earnings and **£0.90bn** back to the exchequer once the model has taxed the extra earnings and withdrawn benefits on them. That takes the combined dynamic cost to **£5.72bn**. The elasticity was proposed by Max Mosley and is derived from Brewer et al. (+0.600 hours a week over a mean of 14.319, against a 100% price fall); it is a total-hours effect measured over all mothers including those not working, so it already contains the participation channel and the two margins should not be read as additive. The treatment it comes from was 12.5 extra free hours a week, not a price fall of 100%. See `hours_response.py` and `sources.HOURS_PRICE_ELASTICITY`.
...
**Which take-up flag.** The subsidy is defined for `would_claim_tfc`, Tax-Free Childcare's take-up input. The alternative put to us — read take-up from the extended (30-hour) entitlement's flag instead, since the reform drops TFC's restrictions — is costed alongside it in `subsidy_take_up.extended_entitlement_flag`. It moves the leg the other way from the argument for it: on this data the TFC flag is the higher of the two (0.89 against 0.80 among families with a qualifying child, uncorrelated with each other and with anything else), so the subsidy leg falls from £4.84bn to £4.31bn and its net entrants from about 11,900 to 9,200 in 2027-28. Neither flag is estimated for this reform. The switch is one line, `reforms.SUBSIDY_TAKE_UP_FLAG`.
...
The Baseline tab reports the rebased figure as an illustrative sensitivity, rebasing only the under-5 slice: the subsidy leg falls from £4.84bn to **£4.18bn** and both legs from £6.64bn to **£6.00bn** in 2027-28. It is not a lower bound — the CMA residual it rests on is provider income less entitlement funding, which is parent fees *and other sources*, and scenarios in the other direction exceed the headline.
